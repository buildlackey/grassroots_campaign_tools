...
export function populateDialogFields(model: any): HTMLSelectElement | null {
...
export function wireUpEventHandlers(model: any) {
...
export function renderSelectorForAddressColumn(model: any, preferredSheetSelect: HTMLSelectElement | null) {
...
export function saveSettings(model: any, _evt?: Event) {
...
export function renderHeadersFor(name: string, ctx?: any) {
...
export function onSheetChange(ctx?: any) {
...
export function registerEscHandler() {
